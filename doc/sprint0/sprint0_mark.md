...
**Team Name:** DeerChat  
**Github:** https://github.com/UTSCCSCC01/finalprojectw22-deerchat
...
## Process: process.md (max 10 marks)
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Your mark: 0 - no criteria for prioritizing user stories
  ...
  - Meetings (max 2 marks)
    ...
    Your mark: 1 - days/times of meetings not included 
