...
## Notes:
- No estimation on user stories (no point values recorded in Jira)
- No testable/acceptance criteria found on the user stories on Sprint 1 
- Although all members posted their standups, all of the days for them were mixed up together. The purpose of them is where everyone posts their standup on the same day so that all group members know what the other members are doing each time. (i.e. You posted 3 different standups for Feb 7, 9th and 10 all within a single day)